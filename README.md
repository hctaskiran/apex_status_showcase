> Since the application is in AppStore, I decided to show only in-app screenshots and video, widgets-plugins used in the app and etc. That's why this repostory has been created.
